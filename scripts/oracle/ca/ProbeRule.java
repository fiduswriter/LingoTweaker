...
/**
 * Checks one text with the pinned Catalan LT and prints one line per
 * match: ruleId \t from \t to \t message \t suggestion1|suggestion2...
 *
 * Usage: java ProbeRule <ca-ES|ca-ES-balear|ca-ES-valencia> "<text>" [ruleId ...]
 */
public class ProbeRule {
  public static void main(String[] args) throws Exception {
    ...
    // Level.PICKY runs picky-tagged rules (e.g. DATE_FUTURE_VERB_PAST) too
