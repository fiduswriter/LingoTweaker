#!/usr/bin/env bash
# Java probe for MorfologikCatalanSpellerRule.getSpellingSuggestions.
#
# Usage: scripts/oracle/ca/probe-speller.sh <ca-ES|ca-ES-valencia> word1 word2 ...
set -euo pipefail
...
mkdir -p /tmp/classes
javac -cp "$CP" -d /tmp/classes /oracle-src/ca/SpellerProbe.java
