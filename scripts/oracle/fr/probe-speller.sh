#!/usr/bin/env bash
# Java probe for MorfologikFrenchSpellerRule.getSpellingSuggestions.
#
# Usage: scripts/oracle/fr/probe-speller.sh word1 word2 ...
set -euo pipefail
...
mkdir -p /tmp/classes
javac -cp "$CP" -d /tmp/classes /oracle-src/fr/SpellerProbe.java
