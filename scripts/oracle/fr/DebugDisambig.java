// Prints which French disambiguation rules change the readings of a sentence,
...
public class DebugDisambig {
  public static void main(String[] args) throws Exception {
    ...
    InputStream is = JLanguageTool.getDataBroker().getFromResourceDirAsStream("fr/disambiguation.xml");
    DisambiguationRuleLoader loader = new DisambiguationRuleLoader();
    List<DisambiguationPatternRule> ruleList = loader.getRules(is, lang, "fr/disambiguation.xml");
