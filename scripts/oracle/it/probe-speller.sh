#!/usr/bin/env bash
# Java probe for MorfologikItalianSpellerRule.getSpellingSuggestions.
#
# Usage: scripts/oracle/it/probe-speller.sh word1 word2 ...
set -euo pipefail
...
mkdir -p /tmp/classes
javac -cp "$CP" -d /tmp/classes /oracle-src/it/SpellerProbe.java
