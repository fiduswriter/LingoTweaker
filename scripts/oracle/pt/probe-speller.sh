#!/usr/bin/env bash
# Java probe for MorfologikPortugueseSpellerRule.getSpellingSuggestions.
#
# Usage: scripts/oracle/pt/probe-speller.sh <pt-PT|pt-BR|pt-AO|pt-MZ> word1 word2 ...
set -euo pipefail
...
mkdir -p /tmp/classes
javac -cp "$CP" -d /tmp/classes /oracle-src/pt/SpellerProbe.java
