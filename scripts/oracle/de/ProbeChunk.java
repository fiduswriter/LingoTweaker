// Dump the post-disambiguation token stream of the pinned German LT,
// including `GermanChunker` chunk tags (the D lines of Dump.java, German).
//
// Usage: java -cp ... ProbeChunk <sentences-file> [de-DE|de-AT|de-CH]
// Output per line: S <idx> <sentence> then
//   D <tok idx> <surface> <startPos> <FLAGS> readings|<lemma>:<pos>... [chunks|...]
...
public class ProbeChunk {
  public static void main(String[] args) throws Exception {
    String variant = args.length > 1 ? args[1] : "de-DE";
    JLanguageTool lt = new JLanguageTool(Languages.getLanguageForShortCode(variant));
