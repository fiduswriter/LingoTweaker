// Prints which German disambiguation rules change the readings of a sentence,
// applied one at a time in the same order as XmlRuleDisambiguator.
//
// Usage: java DebugDisambig <sentence> [de-DE]
...
public class DebugDisambig {
  public static void main(String[] args) throws Exception {
    ...
    InputStream is = JLanguageTool.getDataBroker().getFromResourceDirAsStream("de/disambiguation.xml");
    DisambiguationRuleLoader loader = new DisambiguationRuleLoader();
    List<DisambiguationPatternRule> ruleList = loader.getRules(is, lang, "de/disambiguation.xml");
