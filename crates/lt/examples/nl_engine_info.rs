//! Stage-1/3 Dutch engine report: active XML rules, disambiguation rules,
//! skipped counts and compile failures per variant.
//!
//! Usage: `cargo run -p lt --example nl_engine_info [nl-NL|nl-BE]`
...
fn main() {
    ...
    let engine = lt::Engine::builder(lt::Lang::Nl)
        .unwrap()
        .data_dir(data)
