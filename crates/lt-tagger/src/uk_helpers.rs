...
/// `LemmaHelper.DISTANCE_LEMMAS`.
pub const DISTANCE_LEMMAS: &[&str] = &[
    "міліметр",
    "сантиметр",
    "метр",
    "кілометр",
...
/// `LemmaHelper.PSEUDO_NUM_LEMMAS`.
pub const PSEUDO_NUM_LEMMAS: &[&str] = &[
    "десяток",
    "десяток-другий",
    "сотня",
    "сотка",
...
/// `LemmaHelper.PART_INSERT_PATTERN`.
pub fn part_insert_pattern() -> &'static LazyLock<fancy_regex::Regex> {
    static RE: LazyLock<fancy_regex::Regex> = LazyLock::new(|| {
        fancy_regex::Regex::new(concat!(
