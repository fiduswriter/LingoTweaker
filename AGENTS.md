...
scripts/ci/parity.sh en|de|es|fr|it|pt|nl|ca|gl|ro|pl|sk|sl|el|da   # Java-golden languages
...
divergences #10 (2 only-Java + 12 suggestion field diffs). `no`, `nrd` and `gn` are hand-authored
